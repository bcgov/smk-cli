            ...
            <div class="row">
                ...
                <div id="details" class="col s12">
                    ...
                    <div class="row" v-if="editingLayer.type ==='esri-dynamic'">
                        ...
                        <div class="col s12 input-field">
                            <input id="dbcDefinitionExpression" type="text" v-model="editingLayer.dynamicLayers">
                    ...
                    <div v-if="editingLayer.type ==='wms'">
                        <div class="row">
                            <div class="col s12 input-field">
                                <input id="vectorEditUrl" type="text" v-model="editingLayer.serviceUrl">
                                <label for="vectorEditUrl">Service URL</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s6 input-field">
                                <input id="vectorEditUrl" type="text" v-model="editingLayer.layerName">
                                <label for="vectorEditUrl">Layer Name</label>
                            </div>
                            <div class="col s6 input-field">
                                <input id="vectorEditUrl" type="text" v-model="editingLayer.styleName">
    ...
    template:   
        `<li>
            ...
            <div class="collapsible-body">
                ...
                <div class="row">
                    A query Argument defines which attribute in the layer, and how it will be queried. These must be attached to at least one parameter. Multiple values can be assigned to a single parameter as well.
                </div>  
                <div class="row">
...
Vue.component('query-arguments',
{
    ...
    template:   
        `<div class="row">
            ...
            <div class="col s3 input-field">
                <select v-model="argument.arguments[1].id">
                    <option v-for="parameter in query.parameters" v-bind:value="parameter.id">
                        {{ parameter.title }}
                    </option>
                </select>
            ...
            <div class="col s2">
                <a class="waves-effect waves-light btn-small blue-grey darken-2" v-bind:onclick="'deleteArgument(\\'' + query.id + '\\', \\'' + argument + '\\')'" style="width: 140px;">Delete</a>
            </div>
        </div>`
});
...
Vue.component('query-parameters',
{
    ...
    template:   
        `<div class="row">
            ...
            <div class="col s2">
                <a class="waves-effect waves-light btn-small blue-grey darken-2" v-bind:onclick="'deleteParameter(\\'' + query.id + '\\', \\'' + parameter + '\\')'" style="width: 140px;">Delete</a>
            </div>
        </div>`
});