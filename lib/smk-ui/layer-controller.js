...
LayerController.DATABC_SERVICE_URL = 'https://maps.gov.bc.ca/arcgis/rest/services/mpcm/bcgw/MapServer'
...
function getLayerConfig(res)
{
    ...
    console.log('Connecting to DataBC MPCM Layer Catalog at: ' + LayerController.MPCM_OPTIONS.path);
                ...
                else
                {
                    try
                    {
                        var layer = 
                        {
                            ...
                            serviceUrl: LayerController.DATABC_SERVICE_URL,
